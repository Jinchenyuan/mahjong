...
$(JEMALLOC_STATICLIB) : skynet/3rd/jemalloc/Makefile
	cd skynet/3rd/jemalloc && $(MAKE) CC=$(CC) 

skynet/3rd/jemalloc/Makefile :
	cd skynet/3rd/jemalloc && ./autogen.sh --with-jemalloc-prefix=je_ --enable-prof
...
$(LUA_CLIB_PATH)/lkcp.so : 3rd/kcp/ikcp.c 3rd/kcp/lkcp.c 3rd/kcp/lutil.c | $(LUA_CLIB_PATH)
